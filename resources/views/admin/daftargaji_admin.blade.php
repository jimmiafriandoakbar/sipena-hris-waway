...
<div class="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
    ...
    <div class="p-6 border-b bg-slate-50/60">
        ...
        <form method="GET" action="{{ route('admin.daftargaji_admin') }}"
            ...
            <div class="flex flex-col lg:flex-row lg:items-center gap-3 w-full">
                ...
                <div class="relative w-full lg:w-80">
                    <input
                        ...
                        class="w-full h-12 pl-11 pr-4 rounded-2xl border border-slate-300 bg-white text-sm shadow-sm focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition">
                ...
                <select name="jabatan"
                    class="h-12 px-4 rounded-2xl border border-slate-300 bg-white text-sm shadow-sm focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition">

                    <option value="">Semua Jabatan</option>

                    @foreach($jabatan as $item)
                        <option value="{{ $item->nama_jabatan }}"
                            {{ request('jabatan') == $item->nama_jabatan ? 'selected' : '' }}>
                            {{ $item->nama_jabatan }}
                        </option>
                    @endforeach
                ...
                <button type="submit"
                    class="h-12 px-5 rounded-2xl bg-blue-600 hover:bg-blue-700 text-white transition text-sm font-semibold shadow-sm">
                    Cari
                </button>

                <a href="{{ route('admin.daftargaji_admin') }}"
                    class="h-12 px-5 rounded-2xl border border-slate-300 bg-white hover:bg-slate-50 transition text-sm font-medium shadow-sm flex items-center">
                    Reset
                </a>
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('admin.gaji.export') }}"
                    class="h-12 px-5 rounded-2xl bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-semibold transition shadow-sm inline-flex items-center gap-2 whitespace-nowrap">
        ...
        <table class="w-full text-sm whitespace-nowrap">
            ...
            <thead class="bg-slate-50/80 text-slate-500 uppercase text-[11px] tracking-wide">
                <tr>
                    ...
                    <th class="px-6 py-4 text-left">Nama Pegawai</th>
                    ...
                    <th class="px-6 py-4 text-left">Tunjangan</th>
            ...
            <tbody>
                ...
                <tr class="border-t border-slate-100 hover:bg-blue-50/30 transition duration-200">
                    ...
                    <td class="px-6 py-5">
                        <div class="flex justify-end items-center gap-2">
                            ...
                            <button
                                ...
                                class="h-10 w-10 rounded-xl border border-blue-200 bg-blue-50 text-blue-700 hover:bg-blue-100 flex items-center justify-center shadow-sm">
                                <i data-lucide="eye" class="w-4 h-4"></i>
                            </button>

                            <a href="{{ route('admin.editgaji', $p->id) }}"
                                class="h-10 w-10 rounded-xl border border-yellow-200 bg-yellow-50 text-yellow-700 hover:bg-yellow-100 flex items-center justify-center shadow-sm">
                ...
                <tr>
                    <td colspan="8" class="py-16 text-center text-slate-500">
                        Data gaji pegawai tidak ditemukan
                    </td>
                </tr>
