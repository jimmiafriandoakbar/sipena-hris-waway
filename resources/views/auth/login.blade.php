...
<body
    ...
    <!-- LEFT SIDE -->
    <div
        class="w-1/2 relative z-10
        p-16 flex flex-col justify-center text-white">
        ...
        <div class="max-w-xl">
            ...
            <!-- TITLE -->
            <h1
                class="text-6xl font-black leading-tight mb-6">

                HRIS
                <span
                    class="bg-gradient-to-r from-cyan-300 to-fuchsia-400
            ...
            <!-- DESC -->
            <p
                class="text-lg leading-relaxed text-white/75 mb-8">

                HRIS WAWAY adalah sistem informasi kepegawaian di 
            ...
            <form method="POST"
                ...
                <div>
                    ...
                    <input
                        ...
                        class="w-full h-14 mt-2 px-5 rounded-2xl
                        bg-white/10
                        border border-white/20
                        text-white
                ...
                <div>
                    ...
                    <input
                        ...
                        backdrop-blur-xl
                        focus:outline-none
                        focus:ring-4 focus:ring-fuchsia-400/30">
